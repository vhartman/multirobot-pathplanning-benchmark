...
planner_name_to_color = {
    ...
    "birrtstar_no_shortcutting": report_colors["changed birrt"],
    "rrtstar_no_shortcutting": report_colors["changed rrt"],
    ...
    "locally_informed_prm_no_shortcutting": report_colors["changed prm"],
    ...
    "eitstar_no_shortcutting": report_colors["changed eit"],
    "aitstar_no_shortcutting": report_colors["changed ait"],
