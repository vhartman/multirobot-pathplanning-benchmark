...
representative_envs = [
    ...
    ("rai.welding", 2, 1000),
    ("rai.handover", 2, 100),
    ("rai.eggcartons", 2, 500),
    ("rai.bottles", 2, 500),
    # ("rai.box_rearrangement", 2, 7200),
    ("rai.box_rearrangement", 2, 1000),
    ("rai.box_reorientation", 2, 500),
    ("rai.dep_box_reorientation", 2, 1000),
    ("rai.pyramid", 2, 500),
    ("rai.box_stacking", 2, 1000),
    ("rai.dep_box_stacking", 2, 1000),
    ("rai.mobile_wall_four", 2, 1000),
    ("rai.dep_mobile_wall_four", 2, 1000),
    ("rai.mobile_strut", 0, 1000),
