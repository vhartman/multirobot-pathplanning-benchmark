...
base (world){ shape:ssBox size:[.35 .35 .4 .05], color:[1.0,0.5,0.5,1.0], joint:transXYPhi limits: [-5 5 -5 5 -3.14 3.14]}
...
arm2_coll(arm2){ shape:capsule, Q:"t (0 0 0.02)", color:[1.,1.,1.,.2], size:[.3 .06], contact:1 }
#.25 .13
#.25 .08
