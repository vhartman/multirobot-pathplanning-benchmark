base_link: {}
base_link_0 (base_link): { mesh: './abb_crb15000_dual_support/meshes/visual/base_link.stl', color: [0.3450980 0.3647059 0.3686275 1], visual: true }
link_1: {}
...
joint_1_origin (base_link): { Q: [0 0 0.265] }
joint_1 (joint_1_origin link_1): { joint: hingeZ, limits: [-5.559265359 5.5159265359], ctrl_limits: [2.18166156499 -1 150],}
joint_2 (link_1 link_2): { joint: hingeY, limits: [-5.559265359 5.5159265359], ctrl_limits: [2.18166156499 -1 150],}
...
joint_4 (joint_4_origin link_4): { joint: hingeX, limits: [-5.559265359 5.5159265359], ctrl_limits: [3.49065850399 -1 150],}
joint_5_origin (link_4): { Q: [0.470 0 0] }
joint_5 (joint_5_origin link_5): { joint: hingeY, limits: [-5.559265359 5.5159265359], ctrl_limits: [3.49065850399 -1 150],}
joint_6_origin (link_5): { Q: [0.101 0 0.080] }
joint_6 (joint_6_origin link_6): { joint: hingeX, limits: [-5.559265359 5.5159265359], ctrl_limits: [3.49065850399 -1 150],}
...
coll0(base_link)   { shape:capsule color:[1.,1.,1.,.6] size:[.15 .08] Q:"t(-.0 .0 .1) d(90 0 0 1)", contact:-2  }
...
coll4_0(link_4)   { shape:capsule color:[1.,1.,1.,.6] size:[.19 .06] Q:"t(.14 -.0 .0) d(90 0 1 0)", contact:-2  }
...
coll6(link_6)   { shape:capsule color:[1.,1.,1.,.6] size:[.14 .06] Q:"t(-0.12 -.0 .0) d(90 0 1 0)", contact:-2  }
